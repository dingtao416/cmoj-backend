package com.cm.cmoj.utils.comment;

import com.cm.cmoj.config.discuss.properties.BlogProperties;
import com.cm.cmoj.constant.PageConstants;
...
import com.cm.cmoj.utils.HashUtils;
import com.cm.cmoj.utils.IpAddressUtils;
import com.cm.cmoj.utils.StringUtils;
import com.cm.cmoj.utils.comment.channel.CommentNotifyChannel;
...
//	}
	 ...
	 */
//	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.cm.cmoj.model.entity.Comment parentComment) {
...
//	}
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.cm.cmoj.model.entity.Comment parentComment, Comment comment) {

package com.cm.cmoj.utils.telegram;
...
import com.cm.cmoj.service.MomentService;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			com.cm.cmoj.model.dto.discuss.Comment comment = new com.cm.cmoj.model.dto.discuss.Comment();

...
public class SparkAIManager extends WebSocketListener {
    ...
    public static final String appid = "16bb66e3";
    // todo 替换成你自己的 apiSecret 图书管理系统 1.1 版本
    public static final String apiSecret = "YjYzYzk0MGJmMzdjNzI0NzIzZTU3ZTM1";
    // todo 替换成你自己的 apiKey 图书管理系统 1.1 版本
    public static final String apiKey = "b9fb3e4b5d20fce542e8eb4c6fb08a1f";
